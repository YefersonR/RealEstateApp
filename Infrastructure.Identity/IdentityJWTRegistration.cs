...
{
    public static class IdentityJWTRegistration
    {
        public static void AddIdentityjwtInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            #region Context
